...
//        m_nodeidDistMap[i] = NodeDistancePair(i, INFINITY);
    for (int i=0; i<m_numNodes; i++)
...
{
//    const list<EdgeDistancePair>& edlist = m_adjacencyEdgeMap[nodeid];
...
{
//    list<EdgeDistancePair>& edlist = m_adjacencyEdgeMap[nodeid0];
